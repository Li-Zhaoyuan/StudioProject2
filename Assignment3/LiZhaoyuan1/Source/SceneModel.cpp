...
void SceneModel::Init()
{
	...
	meshList[GEO_MODEL2] = MeshBuilder::GenerateOBJ("model2", "OBJ//test2.obj");
	meshList[GEO_MODEL2]->textureID = LoadTGA("Image//chair.tga");
