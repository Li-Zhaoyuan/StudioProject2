...
void SceneText::Init()
{
	...
	meshList[GEO_BOTTOM]->textureID = LoadTGA("Image//snowBottom.tga");
	...
	meshList[GEO_MODEL1] = MeshBuilder::GenerateOBJ("model1", "OBJ//SpaceShuttle.obj");
	meshList[GEO_MODEL1]->textureID = LoadTGA("Image//SpaceShuttle.tga");
	meshList[GEO_MODEL1]->material.kAmbient.Set(0.5f, 0.5f, 0.5f);
	meshList[GEO_MODEL1]->material.kDiffuse.Set(0.5f, 0.5f, 0.5f);
	meshList[GEO_MODEL1]->material.kSpecular.Set(0.5f, 0.5f, 0.5f);
	meshList[GEO_MODEL1]->material.kShininess = 5.f;
	meshList[GEO_MODEL2] = MeshBuilder::GenerateOBJ("model2", "OBJ//SpaceReliantRobinZERO.obj");
	meshList[GEO_MODEL2]->textureID = LoadTGA("Image//150592K_SpaceReliantRobinZERO_Texture.tga");
	meshList[GEO_MODEL2]->material.kAmbient.Set(0.5f, 0.5f, 0.5f);
	meshList[GEO_MODEL2]->material.kDiffuse.Set(0.5f, 0.5f, 0.5f);
	meshList[GEO_MODEL2]->material.kSpecular.Set(0.5f, 0.5f, 0.5f);
	meshList[GEO_MODEL2]->material.kShininess = 5.f;
